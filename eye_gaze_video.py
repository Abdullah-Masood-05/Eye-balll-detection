...
class EnhancedGazeTracker:
    def __init__(self, buffer_size=5, confidence_threshold=0.7):
        ...
        self.LEFT_EYE_LANDMARKS = [
            ...
            130, 25, 110, 24, 23, 22, 26, 112, 243  # Additional landmarks for better boundary
        ]
        
        self.RIGHT_EYE_LANDMARKS = [
            362, 382, 381, 380, 374, 373, 390, 249, 263, 466, 388, 387, 386, 385, 384, 398,
            359, 255, 339, 254, 253, 252, 256, 341, 463  # Additional landmarks for better boundary
        ]
    ...
    def compensate_for_head_pose(self, relative_position, head_pose):
        ...
        yaw_compensation = -head_pose['yaw'] * 0.02  # Empirical factor
        pitch_compensation = -head_pose['pitch'] * 0.015  # Empirical factor
    ...
    def get_refined_iris_center(self, landmarks, iris_indices):
        ...
        iris_points = []
        weights = [2.0, 1.0, 1.0, 1.0, 1.0]  # Center point gets more weight
    ...
    def calculate_advanced_relative_position(self, iris_center, eye_landmarks, eye_corners):
        ...
        # Calculate more accurate eye center using corner points
        ...
        # Calculate relative position with improved normalization
        rel_x = (iris_center[0] - eye_center_x) / (eye_width * 0.5)  # Normalized to [-2, 2]
        rel_y = (iris_center[1] - eye_center_y) / (eye_height * 0.5)  # Normalized to [-2, 2]
        
        # Apply non-linear scaling to improve sensitivity in center region
        rel_x = np.tanh(rel_x * 1.5) * 0.8  # Sigmoid-like mapping
    ...
    def determine_enhanced_gaze_direction(self, left_rel_pos, right_rel_pos, head_pose, ear_left, ear_right):
        ...
        # Check eye quality (blink detection)
        if ear_left < self.ear_threshold or ear_right < self.ear_threshold:
            return "Blinking", 0.0
        
        # Average relative positions with quality weighting
        ...
        # Adaptive thresholds based on head pose
        ...
        if len(recent_positions) > 1:
            ...
            confidence = max(0.0, 1.0 - position_variance * 10)  # Higher variance = lower confidence
        else:
            confidence = 0.5
        
        # Determine horizontal direction with hysteresis
        ...
        # Determine vertical direction with hysteresis
    ...
    def draw_enhanced_annotations(self, image, left_eye, right_eye, left_iris, right_iris, 
        ...
        # Draw eye regions with different colors based on quality
        ...
        # Main gaze direction with confidence
    ...
    def process_frame(self, frame):
        ...
        if results.multi_face_landmarks:
            ...
            try:
                ...
                # Get eye corners for better reference
                ...
                # Store iris positions for smoothing
                ...
                # Calculate advanced relative positions
                ...
                # Determine enhanced gaze direction
    ...
    def calibrate_personal_thresholds(self, calibration_frames):
        ...
        # This would involve showing calibration points and recording gaze patterns
        # For now, we'll use adaptive thresholds based on detection stability
        pass
    
    def process_video(self, input_path, output_path=None, display=True):
        """Process video with enhanced accuracy tracking."""
        ...
        print(f"Processing video with Enhanced Gaze Tracker: {input_path}")
        ...
        while True:
            ...
            if frame_count % 30 == 0:
                ...
                print(f"Progress: {progress:.1f}% | Avg Confidence: {avg_conf:.2f}")
